...
namespace Sat.Recruitment.Domain.Core
{
    ...
    public static class Ensure
    {
        ...
        public static TEntity ExistEntity<TEntity>(TEntity entity, string keyEntity) where TEntity : class
        {
            if (entity == default(TEntity))
            {
                throw new EntityNotFoundException(typeof(TEntity), keyEntity);
            }
            return entity;
        }
        ...
        public static class Argument
        {
            ...
            public static void NotNullOrEmpty(string value, string paramName = "")
            {
                if (value == null)
                {
                    throw new ArgumentNullException(paramName, "String cannot be null");
                }

                if (string.Empty.Equals(value))
                {
                    throw new ArgumentException(paramName, "String cannot be empty");
                }
            }
        }
    }
